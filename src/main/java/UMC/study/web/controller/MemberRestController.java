...
public class MemberRestController {
    ...
    public ApiResponse<MemberResponseDTO.MissionListDTO> getChallengingMissionList(@ExistStore @PathVariable(name = "memberId") Long memberId, @RequestParam(name = "page") Integer page){
